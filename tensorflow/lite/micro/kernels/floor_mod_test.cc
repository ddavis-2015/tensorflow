...
TF_LITE_MICRO_TEST(FloorModSimple) {
  ...
  constexpr int32_t kExpect[] = {0, 1, 2, 3};
...
TF_LITE_MICRO_TEST(FloorModNegativeValue) {
  ...
  constexpr int32_t kInput2[] = {2, 2, -3, -4};
  constexpr int32_t kExpect[] = {0, 1, -2, -1};
  constexpr int kOutputCount = std::extent<decltype(kExpect)>::value;
  int32_t output_data[kOutputCount];
...
TF_LITE_MICRO_TEST(FloorModBroadcast) {
  ...
  constexpr int32_t kExpect[] = {-2, 0, -2, -2};
  constexpr int kOutputCount = std::extent<decltype(kExpect)>::value;
  int32_t output_data[kOutputCount];
...
TF_LITE_MICRO_TEST(FloorModInt64WithBroadcast) {
  constexpr int kDims1[] = {4, 1, 2, 2, 1};
  constexpr int kDims2[] = {1, 1};
  constexpr int64_t kInput1[] = {10, -9, -11, (1LL << 34) + 9};
  constexpr int64_t kInput2[] = {-(1LL << 33)};
  constexpr int64_t kExpect[] = {-8589934582, -9, -11, -8589934583};
  constexpr int kOutputCount = std::extent<decltype(kExpect)>::value;
