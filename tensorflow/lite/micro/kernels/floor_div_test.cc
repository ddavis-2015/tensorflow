...
void ExecuteFloorDivTest(TfLiteTensor* tensors, int tensors_count) {
  ...
  const TfLiteRegistration registration =
      tflite::ops::micro::Register_FLOOR_DIV();
...
TF_LITE_MICRO_TEST(FloorDivTestSimple) {
  constexpr int kDims[] = {4, 1, 2, 2, 1};
  constexpr int32_t kInput1[] = {10, 9, 11, 3};
  constexpr int32_t kInput2[] = {2, 2, 3, 4};
  constexpr int32_t kExpect[] = {5, 4, 3, 0};
...
TF_LITE_MICRO_TEST(FloorDivTestNegativeValue) {
  constexpr int kDims[] = {4, 1, 2, 2, 1};
  constexpr int32_t kInput1[] = {10, -9, -11, 7};
  constexpr int32_t kInput2[] = {2, 2, -3, -4};
  constexpr int32_t kExpect[] = {5, -5, 3, -2};
  constexpr int kOutputCount = std::extent<decltype(kExpect)>::value;
  int32_t output_data[kOutputCount];
